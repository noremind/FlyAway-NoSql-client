      ...
      <div class="payment__card">
        ...
        <div class="payment__methods-block">
          ...
          <p v-else class="payment__note">
            Данные карты проверяются только для оформления демо-оплаты. Полный
            номер карты и CVV не сохраняются.
          </p>
        </div>
      </div>
...
const paymentOptions = [
  {
    ...
    value: "card",
    hint: "Оплата картой с проверкой данных",
  },
  {
    label: "Оплата бонусами",
    value: "bonus",
    hint: "Списание доступного бонусного баланса",
  },
];
...
const validateCardForm = () => {
  ...
  if (payload.number.length !== 16) cardErrors.number = "Введите ровно 16 цифр";
